...
module.exports = function (email, code) {
    const mailOptions = {
     ...
     <p><a href="http://${config.login_server}:${config.login_port}/users/checkCode?email=${email}&code=${code}">http://${config.login_server}:${config.login_port}/users/checkCode?email=${email}&code=${code}</a></p>
